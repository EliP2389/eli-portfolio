      ...
      <div className="row">
        <div className="card proj_one col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://nft-yt-challenge.vercel.app/"
            >
              NFT DROP
            </a>
          </div>
          ...
          <div className="card-footer">
            <a
              className="proj-link"
              href="https://github.com/EliP2389/nft-yt-challenge.git"
            >
              GitHub Repo
            </a>
          </div>
        ...
        <div className="card proj_one col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://metaverse-challenge-lyart-eight.vercel.app/"
            >
              Metaverse
            </a>
          </div>
          ...
          <div className="card-footer">
            <a
              className="proj-link"
              href="https://github.com/EliP2389/enterThemetaverse123.git"
            >
              GitHub Repo
            </a>
          </div>
        ...
        <div className="card proj_two col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://elip2389.github.io/netflix-clone-build/"
            >
              Netflix Clone
            </a>
          </div>
          ...
          <div className="card-footer">
            <a
              className="proj-link"
              href="https://github.com/EliP2389/netflix-clone-build.git"
            >
              GitHub Repo
            </a>
          </div>
        ...
        <div className="card proj_three col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://ancient-depths-61432.herokuapp.com/"
            >
              Keep Tasks
            </a>
          </div>
          ...
          />
          <div className="card-footer">
            <a className="proj-link" href="https://github.com/mkohn4/keep.git">
              GitHub Repo
            </a>
          </div>
        </div>
        ...
        <div className="card proj_four col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://eli-budgettracker.herokuapp.com/"
            >
              Budget Tracker
            </a>
          </div>
          ...
          <div className="card-footer">
            <a
              className="proj-link"
              href="https://github.com/EliP2389/realDeal-budget-tracker.git"
            >
              GitHub Repo
            </a>
          </div>
        ...
        <div className="card proj_five col-4">
          <div className="card-header">
            <a
              className="proj-link"
              href="https://watch.screencastify.com/v/3aWZXq728N9NWovtCqgI"
            >
              Employee Tracker
            </a>
          </div>
          ...
          <div className="card-footer">
            <a
              className="proj-link"
              href="https://github.com/EliP2389/employee-tracker.git"
            >
              GitHub Repo
            </a>
          </div>
